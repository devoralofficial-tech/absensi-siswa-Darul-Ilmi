...
<body style="background:#f0fdf9">
    <div class="login-page">
        ...
        <div style="text-align:center;margin-bottom:2rem;position:relative;z-index:1">
            <img src="data:image/jpeg;base64,{{ @base64_encode(@file_get_contents(public_path('images/logo.jpg'))) }}" alt="Logo" style="display:block;margin:0 auto 1.125rem;width:72px;height:72px;border-radius:50%;object-fit:cover;box-shadow:0 8px 28px rgba(13,148,136,0.35)">
            <h1
